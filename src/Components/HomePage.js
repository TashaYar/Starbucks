      ...
      <div>
        <Row style={{ marginRight: "0px" }}>
          ...
          <Button
            ...
            style={
              {
                /*               transform: this.state.visibleNav ? "" : "translate(2px,-2px)",
                 */
              }
            }
          >
          ...
          >
            ...
            <div className="part1">
              ...
              <div>
                ...
                <p>This Summer It Starts With You.</p>
                <p>Order ahead and bag rewards.</p>
              ...
              <div className="card-row-1">
                ...
                <div className="col-12 col-md-6 cardS">
                  <Card className="cards">
                    ...
                    />
                    <Card.Body>
                      <Card.Title>Starbucks® Delivers</Card.Title>
                      <Card.Text>
